...
@interface LPCHDetailsViewController ()

@end

@implementation LPCHDetailsViewController
    ...
    if([_type isEqualToString:@"1"] ){
        ...
        if(section == 1){
            ...
            if(row == 1){
                ...
                [button addTarget:self action:@selector(one_type_buttonClick) forControlEvents:UIControlEventTouchUpInside];
                ...
                [button_one addTarget:self action:@selector(one_type_button_canle) forControlEvents:UIControlEventTouchUpInside];
            ...
            if(row == 0){
                ...
                NSMutableArray * dataArr = [NSMutableArray arrayWithObjects:@"  创建时间 : 2016-06-15  13:20:21",@"  付款时间 : 2016-06-15  13:22:59",@"  支付方式 : 在线支付",@"  就餐时间 : 2016.06.21  18:00",@"  联系电话 : 13633217756",@"  总      额  : ￥750", nil];
    ...
    if([_type isEqualToString:@"3"]){
        ...
        if(section == 2){
            ...
            if(row == 1){
                ...
                NSMutableArray * dataArr = [NSMutableArray arrayWithObjects:@"  创建时间 : 2016-06-15  13:20:21",@"  付款时间 : 2016-06-15  13:22:59",@"  支付方式 : 在线支付",@"  数      量  : 2",@"  就餐时间 : 2016.06.21  18:00",@"  联系电话 : 13633217756",@"  总      额  : ￥750", nil];
    ...
    if([_type isEqualToString:@"4"]){
        ...
        if(section == 1){
            ...
            if(row == 1){
                ...
                [button addTarget:self action:@selector(two_type_buttonClick) forControlEvents:UIControlEventTouchUpInside];
                ...
                [button_one addTarget:self action:@selector(tow_type_canle) forControlEvents:UIControlEventTouchUpInside];
...
#pragma mark 单品预定的 验证核销的点击事件
-(void)one_type_buttonClick{
    
    NSLog(@"单品预定 验证核销");
}
#pragma mark 单品预定的 取消订单的点击事件
-(void)one_type_button_canle{
    
    NSLog(@"单品预定 取消订单");
}

#pragma mark 套餐 验证核销的点击事件
-(void)two_type_buttonClick{
    
    NSLog(@"套餐 验证核销");
    
}

#pragma mark 套餐 取消订单的点击事件
-(void)tow_type_canle{
