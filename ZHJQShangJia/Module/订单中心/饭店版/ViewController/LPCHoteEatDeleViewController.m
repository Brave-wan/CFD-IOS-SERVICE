//
//  LPCHoteEatDeleViewController.m
//  ZHJQShangJia
//
...
@interface LPCHoteEatDeleViewController ()

@end

@implementation LPCHoteEatDeleViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if([_oneTwo isEqualToString:@"1"]){
        ...
        if(row < _data_Arr.count ){
            ...
            //dic[@"eat_date"]
            timeLaebl.text =  [@"就餐时间 : " stringByAppendingString:[self getstring:[NSString stringWithFormat:@"%@",dic[@"eat_date"]]]]; //@"就餐时间 : 2016.06.21  18:30";
            ...
            NSString * all_string = [ NSString stringWithFormat:@"总额 : ￥%@", [self getstring:[NSString stringWithFormat:@"%@",dic[@"real_price"]]]];//dic[@"real_price"]
            ...
            if(row == _data_Arr.count - 1){
                ...
                [button addTarget:self action:@selector(buton_yanzheng:) forControlEvents:UIControlEventTouchUpInside];
                ...
                [button_one addTarget:self action:@selector(button_clanle:) forControlEvents:UIControlEventTouchUpInside];
        ...
        if(row ==0 ){
            ...
            [imageView sd_setImageWithURL:[NSURL URLWithString:[self getstring:_imageUrl]] placeholderImage:[UIImage imageNamed:@"LPCzhanweifu"]];
            ...
            NSString * all = [ NSString stringWithFormat:@"%@", [self getstring:[NSString stringWithFormat:@"%@",dic[@"real_price"]]] ];
            
            NSString * all_string = [ NSString stringWithFormat:@"总额 : ￥%@", [self getstring:[NSString stringWithFormat:@"%@",dic[@"real_price"]]]]; //
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if([_oneTwo isEqualToString:@"2"]){
        ...
        if(_data_DIc != nil){
            ...
            NSString * code_String = [@"订单号 : " stringByAppendingString:[self getstring:[NSString stringWithFormat:@"%@",dic[@"order_code"]]]];
...
#pragma mark 饭店未使用的验证核销
-(void)buton_yanzheng:(UIButton *)sender{
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"确认" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action){
        ...
        dispatch_after(0.2, dispatch_get_main_queue(), ^{
            ...
            NSDictionary *dic_darr;

            
            if([_oneTwo isEqualToString: @"1"]){
                
                dic_darr = _data_Arr[0];
...
#pragma mark 饭店的未使用的取消订单
-(void)button_clanle:(UIButton *)sender{
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"确认" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action){
        ...
        dispatch_after(0.2, dispatch_get_main_queue(), ^{
            ...
            NSDictionary  *  dic = @{@"orderCode":[self getstring:[NSString stringWithFormat:@"%@",dic_darr[@"order_code"]]],@"siId":user_id};
...
-(void)next{
    ...
    if([self.object respondsToSelector:@selector(fandianhuidiao:one:)]){
        
        if([_oneTwo isEqualToString:@"1"]){
            
            [self.object fandianhuidiao:@"未使用" one:@"单品"];
        }else {
            
            [self.object fandianhuidiao:@"未使用" one:@"套餐"];
