...
@interface LPCHoteloverViewController ()

@end

@implementation LPCHoteloverViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if([_oneTwo isEqualToString:@"1"]){
        ...
        if(row ==0 ){
            ...
            [imageView sd_setImageWithURL:[NSURL URLWithString:_imageUrl] placeholderImage:[UIImage imageNamed:@"LPCzhanweifu"]];
